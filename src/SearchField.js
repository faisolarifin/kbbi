        ...
        <div className="my-5">
            <form onSubmit={handleSearchTerm} className="src-group d-flex">
                ...
                { searchTermField && searchTermField != "" ? (
                    <button className="btn px-2 btn-clear" onClick={handleClearTerm}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x" viewBox="0 0 16 16">
